...
<div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-9">
                    <h2>Pagina de Pesquisa</h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="index.html">Material</a></li>
                        <li>Professor (800 materiais / 310 Professores)</li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-content">
                            <h2>
                                1110 Resultados foram encontrados com o tema: <span class="text-navy">“Biologia”</span>
                            </h2>
                            <p><small>Tempo de pesquisa</small><small> (0.23 segundos)</small>                            </p>
